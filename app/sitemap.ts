...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    ...['seo-strategy', 'technical-seo', 'keyword-research', 'rank-tracking', 'competitor-analysis', 'backlink-analysis', 'seo-audits', 'ai-seo', 'local-seo', 'international-seo', 'content-seo', 'ecommerce-seo', 'saas-seo'].map((slug) => ({ url: `https://mate.legitclub.com/seo-services/${slug}`, changeFrequency: 'monthly' as const, priority: 0.8 })),
  ]
}
