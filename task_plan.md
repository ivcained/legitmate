...
| Deployment `34689918386` failed in the VPS build because Privy 3.42 imported undeclared optional Farcaster/Solana/Stripe modules | 1 | Pin the compatible peer packages in the lockfile, verify a clean `npm ci`, then run the full production build before redeploying. |
